...
export const loadFavorites = createAction<FavoriteType[]>('data/loadFavorites');
export const loadReviews = createAction('data/loadReviews', (value: ReviewType[]) => ({ payload: value }));
...
// export const loadCurrentOfferComments = createAction<ReviewType[]>('data/loadCurrentOfferComments');
